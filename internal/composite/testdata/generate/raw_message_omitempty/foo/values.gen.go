...
// Bar is generated from https://example.com/testdata/generate/raw_message_omitempty/foo/bar.json
// Bar gives you null value
type Bar struct {
	Value json.RawMessage `json:"value,omitempty"`
}

// Validate returns an error if this value is invalid according to rules defined in https://example.com/testdata/generate/raw_message_omitempty/foo/bar.json
